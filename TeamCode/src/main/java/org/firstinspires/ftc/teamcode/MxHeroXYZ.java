...
public class MxHeroXYZ {
    ...
    public MxHeroXYZ (BNO055IMU emuIn) {
    ...
    public int getAngleZIntrinsic () {
        return (int) emu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.XYZ, AngleUnit.RADIANS).thirdAngle;
    }
    public float getAngleZExtrinsic () {
        return emu.getAngularOrientation(AxesReference.EXTRINSIC, AxesOrder.XYZ, AngleUnit.RADIANS).thirdAngle;
    }
